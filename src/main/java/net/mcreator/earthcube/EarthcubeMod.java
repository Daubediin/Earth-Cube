 ...
 *
 */
package net.mcreator.earthcube;
...
@Mod("earthcube")
public class EarthcubeMod {
	public static final Logger LOGGER = LogManager.getLogger(EarthcubeMod.class);
	public static final String MODID = "earthcube";
